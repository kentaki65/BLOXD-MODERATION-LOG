...
## 📦️導入
- [メインコード](https://github.com/kentaki65/BLOXD-MODERATION-LOG/blob/main/src/maincode_minified.js)をワールドコードにコピペしてください
> 改造して使いたいですか？ それなら[ここ](https://github.com/kentaki65/BLOXD-MODERATION-LOG/blob/main/src/maincode_original.js)にオリジナルソースがあります
## CONFIG
```js
const config = {
